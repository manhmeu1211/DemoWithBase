...
public extension UIColor {
    ...
    public convenience init(hex: String?, alpha:CGFloat? = 1.0) {
        ...
        self.init(red:UIColorMasks.redValue(c), green:UIColorMasks.greenValue(c), blue:UIColorMasks.blueValue(c), alpha:alpha!)
    }
...
extension UIColor {
    static let grayLineView = UIColor(hex: "#E5E5E5")
    static let mainRedColor = UIColor(hex: "#BC2228")
    static let grayText = UIColor(hex: "#989898")
    static let grayBG = UIColor(hex: "F6F6F6")
    static let blackText = UIColor(hex: "#251C1C")
    static let otLineView = UIColor(hex: "#D3ADF9")
    static let leaveLineView = UIColor(hex: "#FBBD10")
    static let supplementLineView = UIColor(hex: "#59B19A")
}


extension UIColor {
    static let grayBackgroundColor = UIColor(hexString: "F6F6F6")
    static let redBackgroundColor = UIColor(hexString: "BC2228")
    static let grayTextColor = UIColor(hex: "989898")
    static let lineViewColor = UIColor(hex: "E5E5E5")
